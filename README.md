...
| **Bamboo Construction** | Demand ceiling (framing market too small) | Supply gap (37 Mha mostly unmanaged) | 6-12x managed plantation; 12-40x structural product output | Displace concrete/masonry in developing world, not just wood framing |
...
**Bamboo Construction:** At first glance the supply side looks easy — current bamboo area is ~37 Mha, and 1 Gt in durable products requires 40-83 Mha. But that 37 Mha is misleading: most of it is **unmanaged natural forest** (India alone has 10-15 Mha of wild stands used for crafts and pulp). Actual commercial harvest is ~30 Mt/yr, almost entirely in China, and only **~3-5 Mt/yr** becomes engineered structural product — the rest goes to scaffolding, paper, chopsticks, charcoal, and food. The 12-25 tCO2/ha/yr yield assumes optimally managed plantations; real harvest rates from existing stands are 5-10x lower. So the supply side requires not just more land, but converting natural stands to managed plantations and redirecting output from low-value uses to construction. On the demand side, engineered bamboo competes with **wood framing and light-gauge steel framing**, which together total only **~110-140 Mt/yr globally**.[^41] Replacing *all* of it with bamboo would store roughly **0.2-0.4 GtCO2/yr** — well short of 1 Gt. To reach beyond that, bamboo would have to displace concrete and masonry in countries where wood framing barely exists — a market-creation problem, not a material-substitution problem.[^33][^41]
